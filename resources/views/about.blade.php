...
@section("content")
   ...
   <div class="about-content mt-5">
        ...
        <div class="container">
            <div class="why-choose-us-container text-center mt-4">
            ...
            <div class="row mt-4 why-choose-us-icons-wrapper p-5">
                <div class="col-lg-4 text-center px-4">
                    ...
                    <p>Sit back while our sales team is working on your query. We have dedicated account managers to assist you at every stages. We also offer a limited free post-sales service based on your purchase.</p>
                </div>
                <div class="col-lg-4 text-center px-4">
                    <div class="why-choose-us-icon-box">
                    ...
                    <p>We have a dedicated team of service executives working round the clock to handle your queries. Our service executives are able to reach out to you with proper resolutions based on your queries.</p>
                </div>
                <div class="col-lg-4 text-center px-4">
                    <div class="why-choose-us-icon-box">
