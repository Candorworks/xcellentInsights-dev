    ...
    <div id="page-wrapper">
        <div class="container-fluid">
          ...
          <x-alert/>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="white-box">
                        <x-alert />
                        <div class="row">
                            <form action="{{ route('admin.orderlist.inactive') }}" method="GET" >
                                <div class="form-row">
                                        ...
                                        <th>
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <button class="btn btn-outline btn-rounded btn-info"
                                                  onclick="return orderInactive();">Activate</button>
                                            </div>    
                                        </th>
                                        <th>ID</th>
                                        <th>Date</th>
                                ...
                                <tbody>
                                    @foreach ($list as $item)
                                        <tr>
                                            ...
                                            {{-- <td><i class="fa fa-toggle-off fa-xl fa-fw"></i></td> --}}
                                            {{-- <td>{!! (int)$item->active === 1 ?'active':'inactive' !!}</td> --}}
                                            {{-- <td>{!! $item->remark!!}</td> --}}
                                            <td><label class="switch">
                                                <input type="checkbox" onclick="return orderStatusChange({!! $item->id !!});" id="select_reports_status{!! $item->id !!}" name="select_reports_status" value="{!! $item->id !!}" >
                                                <span class="slider round" style="background-color:#4d4e63"></span>
                                                </label>
                                            </td>
                                        </tr>
                                    @endforeach
            ...
            <form id="order-inactive" action='{{ route('admin.order.inactive') }}' method="POST">
                @csrf
                <input type="hidden" name="report_ids" class="report_ids" id="report_ids" value="">
            </form>
        ...
        <script>
            ...
            function orderInactive() {
                ...
                if (searchIDs.length == 0) {
                    alert('please select order to active.');
                    return false;
                }
                $(".report_ids").val(searchIDs);
                $("#order-inactive").submit();
            }
