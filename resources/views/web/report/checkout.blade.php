                        ...
                        <div class="p-3">
                            <div class="methods">
                                <div class="debit-credit">
                                    ...
                                    <label for="card" id="debit-credit">Credit / Debit Card <img src="{{ asset('web/images/checkout/credit-card.png') }}" alt="" height="21px"></label>
                                </div>
                                <div class="bank-transfer mt-3">
                                    <input type="radio" name="card" id="transfer">
                                    <label for="transfer" id="bank-transfer">Direct Bank Transfer <img src="{{ asset('web/images/checkout/direct-bank-transfer.png') }}" alt="" height="21px"></label>
                            ...
                            <div class="we-accept row mt-5 align-items-center pt-3">
                                ...
                                <div class="col-lg-7"><img src="{{ asset('web/images/payment-logos.png') }}" alt="payment-logo"></div>
                            </div>
                        </div>
                    </div>
                </div>
