    ...
    <div class="breadcrums-container py-5"
        ...
        <div class="container pt-5">
            <div class="text-center mt-3">
                <h3 class="breadcrumbs-title  fw-bold text-white">@if(isset($categories)) {{ $categories->name }} @else Report Hub @endif</h3>
                <p class="mt-4 px-5 text-light text-center">@if(isset($categories)) {{ $categories->information }} @endif</p>
            </div>
        </div>
    </div>
