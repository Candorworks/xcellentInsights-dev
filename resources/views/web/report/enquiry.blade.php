                        ...
                        <div class="free-pdf-form mx-5">
                            <form id="free-pdf-form" method="post" action="{{ route('lead.create') }}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <input type="number" class="form-control shadow-inset" name="number" placeholder="Phone No. " required="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <textarea class="form-control shadow-inset" name="description" placeholder="Share your Requirements(if any)" required=""></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row form-group align-items-center">
                                    <div class="col-lg-6 ">
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="tel" class="textbox form-control shadow-inset speakWithAnalystValidationEnquiry" name="captchainput" placeholder="Ans" style="margin-left: -20px;" />
                                ...
                                <div class="col-lg-12 ">
                                    <div class="submit-btn mt-4 text-center">
                                        <button type="submit" class="cta-btn px-3" id="speakWithAnalystSubmitBtnEnquiry">Submit
                                        </button>
                                    </div>
                                </div>
                                <div class="text-center mt-3 text-muted">
                                    <small>We ensure complete secrecy of your personal details. <a href="{{ route('privacy') }}" style="color: #002c60">Privacy
                                            Policy</a></small>
                                </div>
