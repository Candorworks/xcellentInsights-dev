...
@section('content')
<div class="breadcrums-container py-5" style="background-image: linear-gradient(45deg, rgb(0 0 0 / 65%), rgb(0 0 0 / 65%)),url(../web/images/breadcrums/contact-us.webp);">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-lg-12">
                                            <div class="form-group mt-3">
                                                ...
                                                <div class="g-recaptcha" data-sitekey="6Lf4uisjAAAAALKzirLZbJrXDevMeUHE85YWOqKe"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 ">
                                ...
                                <div id="collapsePrice" class="accordion-collapse collapse" aria-labelledby="headingPrice" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <div class="form-group individual-report-price  justify-content-around">
                                            <input type="radio" id="single" value="single" name="price1" checked="selected">
        ...
        "itemListElement": [{
            ...
            },
            {
                ...
                "item": {
                    "type": "WebPage",
                    "@id": "/{{$report->slug}}",
                    "name": "{{$report->title}}/{{$report->meta_title}}"
                }
            }
        ]
    }
