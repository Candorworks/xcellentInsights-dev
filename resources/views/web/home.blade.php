...
<div class="hero-section">
    <video class="video-fluid" autoplay loop muted style="height: auto; width: 100%; margin-top: -25px;" <source src="{{ asset('web/videos/new_slide.mp4') }}" type="video/mp4">
    </video>
            ...
            <div class="col-lg-6 pe-5">
                <div class="owl-carousel owl-theme" id="testi">
                    ...
                    <div class="individual-testimonial">
                        ...
                        <div class="posted-by">
                            <div class="user">
                                <h6 class="name">~ Director of Research & development, <span class="designation fw-light">Electronics &
