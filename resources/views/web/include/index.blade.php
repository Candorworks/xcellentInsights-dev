            ...
            <div class="row form-controller">
                ...
                <div class="col-lg-6 p-3">
                    <form role="form" id="enquiry-form" method="POST" autocomplete="on"
                        action="https://www.xcellentinsights.com/lead/create" onsubmit="return validateBot();">
                        <input type="hidden" name="_token" value="TLc9btQ0HY5Zfgnwj4uxqkiSWeBmjgErJSdXDS6u">
                        ...
                        <div class="row form-group my-2 align-items-center">
                            ...
                            <div class="col-lg-4 mt-1 p-0" style="margin-left: -64px; margin-top: -20px;">
                                ...
                                <div class="text-danger fail" id="validationfail" style="display:none;">Validation
                                    failed</div>
                            </div>
                        </div>
                        <div class="modal-footer pe-3">
                            <button type="button" class="btn bg-grey mr-15 w-25 white-btn p-2 modalCloseBtn"
