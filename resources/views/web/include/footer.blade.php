                ...
                <div class="container address-widget ps-0">
                    <div class="row">
                        ...
                        <div class="col-lg-11 desc">
                            <p>NY, New York City - Broad Street (HQ) <br> 80 Broad Street 5th Floor <br> New York City
                                10004</p>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-lg-11 desc">
                            <a href="mailto:support@xcellentinsights.com"
                                class="footer-email">support@xcellentinsights.com</a>
                        </div>
                    </div>
                    <div class="row my-3 justify-content-center">
                        <div class="col-lg-6 px-0">
                            <ul class="footer-social text-center p-0 ">
                                ...
                                <li><a href="https://www.pinterest.com/xcellentinsights/" target="_blank"><i
                                            class="fab fa-pinterest-p"></i></a></li>
                                <li><a href="https://www.linkedin.com/company/xcellent-insights" target="_blank"><i
