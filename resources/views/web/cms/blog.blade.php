                    ...
                    <a href="{{ route('blog-details', ['blog_slug' => $result['slug']]) }}" style="text-decoration: none;">
                        <div class="blog-img-box">
                            @if ($result->image == null)
                                <img class="img-fluid" src="{{ asset('web/images/blog/5.jpg') }}" alt="Image Processing"
                                    style="height:250px; width:415.99px;">
                            @else
                                <img class="img-fluid" src="{{ asset('web/' . $result->image) }}" alt="Image Processing"
                                    style="height:250px; width:415.99px;">
                            @endif
                        </div>
