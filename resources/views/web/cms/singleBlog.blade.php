    ...
    <div class="container">
        <div class="row justify-content-around">
            <div class="col-lg-7 blog-content-container p-5">
                @if(($blog->image)==null)
                <div class="blog-bg px-3 py-4 m-0" style="background-image: linear-gradient(45deg, rgb(60 59 64 / 34%), rgb(8 83 156 / 51%)),url('{{asset('web/images/blog/5.jpg')}}'); ">
                    ...
                    <div class="text-light pt-2">
                        ...
                        <span class="pe-2"><small>{{ Carbon\Carbon::parse($blog->created_at)->diffForHumans()}}</small></span>
                ...
                @else
                <div class="blog-bg px-3 py-4 m-0" style="background-image: linear-gradient(45deg, rgb(60 59 64 / 34%), rgb(8 83 156 / 51%)),url('{{asset('web/'. $blog->image)}}'); ">
                    <p class="blog-badge mb-3">{{$blog->category->name}}</p>
                    <h3 class="mb-3 text-light"> {{$blog->title}}</h3>
                    <div class="text-light pt-2">
                        <i class="fa fa-user fa-2xs" aria-hidden="true"></i>
                            ...
                            <div class="row pb-4">
                                <div class="col-lg-5">
                                    <div class="recent-post-img-box">
                                        ...
                                        <img class="img-fluid" src="{{asset('web/images/blog/5.jpg')}}" alt="">
                                        @else
                                        <img class="img-fluid" src="{{asset('web/'.$result->image)}}" alt="">
                                        @endif
                                    </div>
                                </div>
                                <div class="col-lg-7">
                                    ...
                                    <div class="recent-single-post-calender">
                                        ...
                                        <span class="pe-2"><small>{{ Carbon\Carbon::parse($result->created_at)->diffForHumans()}}</small></span>
                                    </div>
                                </div>
                            </div>
                            @endforeach
