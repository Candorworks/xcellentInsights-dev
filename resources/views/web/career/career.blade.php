            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="join-our-team-desc mt-3">
                        <p>
                            Join our team to start your consulting career with us. If you are passionate about market
                            research and consulting we have a pool of opportunities for you. To apply, please send your
                    ...
                    <form action="" class="contact-form" method="post" id="career-form" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control input-field-career" name="name"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="email" class="form-control input-field-career" name="email"
                                        value="{{ old('email') }}" placeholder="Email" required="">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control input-field-career" maxlength="12"
                                        onkeypress="return isNumber(event)" name="phone" value="{{ old('phone') }}"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control input-field-career" name="resume_title"
                                        value="{{ old('resume_title') }}" placeholder="Resume Title" required="">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input input-field-career" name="resume_file"
                                        placeholder="Resume Title*" required="">
                                    <label class="custom-file-label input-field-career " for="customFile">Upload
                                        Resume</label>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <textarea name="msg" class="form-control input-field-career" placeholder="Your Message Here" rows="5"
