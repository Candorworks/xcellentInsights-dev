        ...
        <div class="row align-items-center" >
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 pe-0">
                                                <input type="text" class="form-control form-fields" name="fname" placeholder="First name" required="">
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control form-fields" name="lname" placeholder="Last Name" required="">
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-6 mb-3">
                                    <div class="form-group">
                                        {{-- <label>Email*</label> --}}
                                        <input type="email" class="form-control form-fields" placeholder="Enter email" name="email" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 mb-3">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" maxlength="12" onkeypress="return isNumber(event)" class="form-control form-fields" placeholder="Enter number" name="number" />
                                    </div>
                                </div>
                                <div class="col-lg-6 mb-3">
                                    <div class="form-group ">
                                        {{-- <label>Company Name*</label> --}}
                                        <input type="text" class="form-control form-fields" name="company" placeholder="Enter company name" />
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-fields" name="website" placeholder="Enter company website" />
                                    </div>
                                </div>
                                <div class="col-lg-6 mb-3">
                                    <div class="form-group">
                                        {{-- <label>No of reports*</label> --}}
                                        <input type="text" onkeypress="return isNumber(event)" name="reports_no" class="form-control form-fields" placeholder="Enter no of reports " />
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" onkeypress="return isNumber(event)" name="new_publications" class="form-control form-fields" placeholder="Enter yearly new publications" />
                                    </div>
                                </div>
                                <div class="col-lg-6 mb-3">
                                    <div class="form-group">
                                        {{-- <label>Descreption*</label> --}}
                                        <textarea name="description" class="form-control form-fields" id="" cols="30" rows="3" placeholder="Brief company introduction"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-4 justify-content-between">
                                <div class="col-lg-8 py-2">
                                    <div class="form-group">
                                        ...
                                        <span style="padding-left: 10px"> Yes, I have read the <a href="{{route("terms")}}" style="color: #002c60; text-decoration: none;">terms of the agreement.</a></span>
                                    </div>
                                </div>
                                <div class="col-lg-3">
            ...
            <div class="col-lg-4 p-0">
                <div class="partner-contact-text px-5 py-4">
                    ...
                    <p>Partner with us to grow and expand your business reach. If you are a reseller, channel partner or VAR we would love to talk to you. Drop in your details and our partner relations executive will connect with you sooner.</p>
                </div>
            </div>
        </div>
    </div>
